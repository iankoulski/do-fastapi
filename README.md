# do-fastapi - run a FastAPI server using the [do-framework](https://bit.ly/do-framework)

This project builds a simple [FastAPI](https://fastapi.tiangolo.com/) container which is useful for debugging web serving connectivity.
